    ...
    <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;">
      <el-form :model="configure" :rules="rules" ref="configureForm" label-width="100px">
          ...
          <el-tab-pane label="基础配置" name="base" style="padding: 5px">
            ...
            <el-form-item label="博客描述" prop="blogDescribe">
              <el-input
                ...
                :placeholder="'欢迎来到' + configure.githubUsername + '的个人博客。'"
              ></el-input>
            </el-form-item>
        ...
        <el-form-item>
          ...
          >
            <el-button slot="reference" icon="el-icon-question" type="text" style="float: right;"
              >说明</el-button
            >
          </el-popover>
        </el-form-item>
  ...
  export default {
    data() {
      return {
        ...
        initConfigure: {},
        rules: {
          githubUsername: [{ required: true, message: '请输入用户名', trigger: 'blur' }],
          blogTitle: [
